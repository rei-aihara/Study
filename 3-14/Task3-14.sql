...
INNER JOIN store_table TBL1 ON TBL1.store_code = TBL3.store_code
INNER JOIN goods_table TBL2 ON TBL2.goods_code = TBL3.goods_code;
...
VALUES ('M001','マフラー',4500,'2025-08-10');
...
VALUES ('EA09', '新宿店', 'SHINJUKUTEN', '2012-08-01'),
...
UPDATE stock_table SET quantity=50
WHERE quantity >= 20;
